  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={cn(
          'font-display border-brand-200 text-brand-700 hover:border-brand-300 hover:bg-brand-50 flex items-center justify-center gap-1 rounded-md border bg-white text-[10px] font-semibold transition-colors active:scale-95',
          isCompact ? 'h-6 flex-1' : 'h-7 flex-1',
        )}
      >
