...
export function ProductReviews({
  ...
  const handleImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    files.forEach((f) =>
      setFormPreviews((prev) => [...prev, URL.createObjectURL(f)]),
    )
  }
  ...
  return (
    <section className="container-page border-t border-neutral-200 py-12">
      {/* ── Heading ── */}
        ...
        {totalCount > 0 && (
          <div className="mt-6 max-w-md space-y-3">
            {ratingBars.map(({ star, pct, count }) => (
              ...
              >
                <span className="hover:text-brand-600 w-16 flex-shrink-0 text-right text-neutral-600">
                  {star} star
                </span>
                ...
                <span className="w-8 flex-shrink-0 text-right text-neutral-400">
                  {count}
                </span>
              </button>
            ))}
      ...
      <div className="mt-10">
        ...
        {showForm && (
          <form
            ...
            className="border-brand-200 bg-brand-50/20 mb-10 rounded-2xl border p-6 sm:p-8"
          >
            <h3 className="font-display text-lg font-semibold text-neutral-900">
              Share your thoughts
            </h3>
            <p className="font-body mt-1 text-sm text-neutral-500">
              Your review helps other customers make informed choices.
            </p>

            {formError && (
              <p className="mt-4 text-xs text-red-600">{formError}</p>
            )}
            ...
            <div className="mt-6">
              ...
              <div className="mt-3 flex items-center gap-2">
                ...
                {formRating > 0 && (
                  <span className="font-body ml-2 text-sm font-medium text-neutral-600">
            ...
            <div className="mt-8 flex justify-end gap-3">
              <button
                ...
                className="font-display h-11 rounded-xl border border-neutral-200 px-5 text-xs font-semibold text-neutral-500 transition-colors hover:bg-neutral-50"
              >
                Cancel
              </button>
              <button
            ...
            <div className="mb-8 flex items-center justify-between border-b border-neutral-200 pb-4">
              ...
              <div className="relative">
                <select
                  ...
                  className="font-body focus:border-brand-500 h-10 appearance-none rounded-xl border border-neutral-200 bg-white pr-8 pl-3 text-xs text-neutral-600 outline-none"
                >
            ...
            <div className="space-y-10">
              {reviews.map((review) => (
                ...
                >
                  ...
                  <p className="font-body mt-4 text-sm leading-relaxed text-neutral-600">
                    {review.body}
                  </p>
