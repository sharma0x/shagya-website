...
function getTimestamp(order: any, stage: string): string | null {
  switch (stage) {
    case 'pending':
    ...
    <div className={cn('', className)}>
      ...
      <div className="flex items-center justify-between">
        {STAGES.map((stage, idx) => {
          ...
          const isLineCompleted = isCancelled ? false : idx < effectiveIdx
      ...
      {status === 'shipped' && order.trackingId && (
        <div className="border-brand-100 bg-brand-50/30 mt-5 rounded-xl border p-4">
