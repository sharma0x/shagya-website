...
export function MobileBottomNav() {
  ...
  return (
    <nav
      className="fixed right-0 bottom-0 left-0 z-30 border-t border-neutral-200 bg-white/95 pb-[env(safe-area-inset-bottom,0px)] backdrop-blur-xl lg:hidden"
            ...
            <>
              <div className="relative">
                ...
                {item.badge === 'cart' && cartCount > 0 && (
                  <span className="bg-brand-600 absolute -top-1 -right-1.5 flex h-4 min-w-[1rem] items-center justify-center rounded-full px-1 text-[10px] leading-none font-semibold text-white">
                    {cartCount}
                  </span>
                )}
