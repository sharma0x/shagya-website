        ...
        <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {collectionsWithCovers.map((col) => (
            <Link
              ...
              className="group block overflow-hidden rounded-2xl border border-neutral-100 bg-white shadow-xs transition-all duration-300 hover:shadow-md hover:-translate-y-0.5"
            >
              <ImagePanel
                src={col.coverImage}
                alt={col.name}
