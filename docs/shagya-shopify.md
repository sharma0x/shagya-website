...
```json
{
  ...
  "options": [
    { "name": "Color", "values": ["Grey", "Blue"], "position": 1 }
  ],
  "images": [
    { "alt": "Grey digital print pure mysore silk saree front", "position": 1, "src": "..." },
    { "alt": "Model wearing grey mysore silk saree", "position": 2, "src": "..." },
    { "alt": "Fabric close-up showing digital print", "position": 3, "src": "..." },
